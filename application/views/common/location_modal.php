...
<div class="modal" id="myModal">
	<button type="button" class="close hide btn-clse" data-dismiss="modal" data-backdrop="static" data-keyboard="false">&times;</button>
		...
		<div class="modal-content location__select">
			...
			<div class="modal-body">
				...
				<div class="row">
					...
					<div class="col-sm-4">
						<div class="location-outer" onclick="location.assign(config.baseUrl+'service/set_location/gaziabad')">
							<img class="img-fluid m-img" src="<?php echo base_url();?>assets/img/shipra-mall.png"> 
							<h4 class="m-head">Gaziabad</h4>
						</div>
					</div>
					<div class="col-sm-4">
