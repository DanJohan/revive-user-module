        ...
        <div class="row">
            ...
            <!--features list-->
                <ul class="list-unstyled ts-list-divided">
                    ...
                    <p>We cover all types of car makes and models, irrespective of brand, make, size, body or fuel type.
                    </p>
                    </div>
                    <!--end collapse-->
                    </li>
                    <li class="faq" id= "faq2" data-toggle="collapse">
                        ...
                        <div class="collapse" id="faqs-2">
                            <p>Absolutely, but you do have choices. If your car is older and you just want an ugly dent removed for minimal cost, we can show you different levels of repair that will meet your expectations and your budget. If your desire is to have your vehicle looking like new again, you can opt for complete body paint services. You can also refresh your car by adding customisation and making it stand apart in a crowd.</p>
                        </div>
                        <!--end collapse-->
                    </li>
