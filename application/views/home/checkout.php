...
.box {
    ...
    padding-right: 43px;
    padding-left: 23px;
    box-shadow: -1px 6px 25px 0px #888888;
    width: 90%;
    margin: 0 auto;
    padding-top: 26px;
...
<section class="cart_custom">
  <div class="container">
    <div class="row">
	   ...
	   <div class="row"><!--scend-penal-->
      
	   <div class="col-md-6 col-sm-6 col-xs-12">
	      <span class="bumper">Front Bumper</span>
	   </div>
	   
	   <div class="col-md-6 col-sm-6 col-xs-12">
	      <span class="price">Rs.1800</span>
		  <span class="entr"><b>ENTER PROMO CODE</b><a href="#">Apply</a></span>
	   ...
	   <div class="col-md-6 col-sm-6 col-xs-12 topbd">
		...
		<div class="row custom_btn">
		  	<div class="col-md-9 col-sm-9 col-xs-12">
		       <span class="additem"><a href="#">ADD MORE ITEMS</a></span>
			</div>
		
			<div class="col-md-3 col-sm-3 col-xs-12"> 
			   <span class="proceed"><a href="#">PROCEED TO CHECKOUT</a></span>
			</div>
		</div>
