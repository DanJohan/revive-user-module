...
<div class="top-bar">
        <div class="container">
                  <div class="row">
                    ...
                    <div class="top-text">
                      <i class="icon fa fa-phone" style="transform: rotate(90deg);"></i>
                       +91-7894561230 
...
<div class="container"> <a class="navbar-brand" href="<?php echo base_url();?>"> 
      <img class="logo" src="<?php echo base_url();?>public/revive-car/assets/img/logo.png" alt=""> </a> 
      <!--end navbar-brand-->
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <ul class="navbar-nav ml-auto">
			...
			<li><a class="nav-item nav-link ts-scroll" href="<?php echo base_url();?>#about-us">About us</a> 
			</li>
			<li class="nav-item dropdown"> <a class="nav-item nav-link ts-scroll nav-link dropdown-toggle" href="#" id="services" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Services</a>
	            <div class="dropdown-menu dp-clr" aria-labelledby="dropdown01"> 
		           <a class="dropdown-item drp-clr" href="car/select_service">Dent repair jobs</a>
		           <a class="dropdown-item drp-clr" href="car/select_service">Paint repair jobs</a>
		           <a class="dropdown-item drp-clr" href="car/select_service">Full Body car paint</a> 
